...
const Footer: React.FC = () => {
  return (
    <footer data-testid="site-footer" className="bg-gray-900 text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="grid md:grid-cols-12 gap-12">
          <div className="md:col-span-5">
            ...
            <p className="text-white/70 text-lg leading-relaxed max-w-md font-sans">
              Plan mat karo. <span className="text-yellow-400">Bas nikal jao.</span>
            </p>
          ...
          <div className="md:col-span-3">
            <h4 className="text-xs uppercase tracking-[0.2em] text-green-400 font-bold mb-5">Explore</h4>
            <ul className="space-y-3">
              <li>
                <a className="text-white/80 hover:text-white transition" href="/trips">All Trips</a>
              </li>
              <li>
                <a className="text-white/80 hover:text-white transition" href="/about">About us</a>
              </li>
              <li>
          ...
          <div className="md:col-span-4">
            <h4 className="text-xs uppercase tracking-[0.2em] text-green-400 font-bold mb-5">Reach out</h4>
            <ul className="space-y-3 text-white/80">
              ...
              <li>
                <a href="https://instagram.com/raahitrail" target="_blank" rel="noreferrer" data-testid="footer-instagram" className="inline-flex items-center gap-2 mt-2 px-4 py-2 rounded-full border border-white/15 hover:bg-white hover:text-gray-900 transition">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <p className="text-white/50 text-sm">
            © {new Date().getFullYear()} Raahi Trail. Made with chai in India.
          </p>
          <p className="text-white/50 text-sm font-sans">
            Yeh trip nahi, <span className="text-yellow-400">experience hai.</span>
          </p>
        </div>
      </div>
    </footer>
